...
router.post('/admin/addBanner/:id', bannerImage.single('image'), validateAccessToken, authorizeRoles("admin"), addBanner); // admin
...
router.post('/admin/addBannerForShopNow/:id', bannerImage.single('image'), validateAccessToken, authorizeRoles("admin"), addBannerForShopNow); // admin
